...
1.- Complexity (3 pts): The program is not entirely complex but it is not trivial either, it contains the necessary notebooks as is postulated in the C Reference Card (ANSI).
